      ...
      <main className="mx-auto w-full max-w-[520px] bg-[#f3f6fb] px-4 pb-28 pt-5 lg:max-w-7xl lg:px-6">
        <section className="mb-5 overflow-hidden rounded-[1.5rem] bg-[#071d49] p-5 text-white shadow-sm">
          ...
          <div className="mt-2 flex items-end justify-between gap-4">
            <div>
              <h1 className="text-3xl font-black">검수 매물</h1>
              <p className="mt-2 text-sm font-bold leading-6 text-white/70">
                고객에게 공개 가능한 정보만 정제한 매물입니다. 상세주소와
          ...
          <div className="mt-5 grid grid-cols-3 gap-2">
            <div className="rounded-[1rem] bg-white/10 p-3 ring-1 ring-white/10">
              <p className="text-xs font-bold text-white/55">공개 기준</p>
              <p className="mt-1 text-sm font-black">시·구 단위</p>
            </div>
            <div className="rounded-[1rem] bg-white/10 p-3 ring-1 ring-white/10">
              <p className="text-xs font-bold text-white/55">금액 표기</p>
              <p className="mt-1 text-sm font-black">범위형</p>
            </div>
            <div className="rounded-[1rem] bg-white/10 p-3 ring-1 ring-white/10">
              <p className="text-xs font-bold text-white/55">민감정보</p>
              <p className="mt-1 text-sm font-black">비공개</p>
            </div>
          </div>
        </section>
